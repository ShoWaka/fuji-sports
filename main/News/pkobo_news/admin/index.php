...
cffs2g($warningMesse02, $cfilePath);
		...
		<table class="borderTable03">
			...
			?>
						<tr class="<?php echo $dspMode; ?>">
							<td nowrap="nowrap"><?php echo ($linesArray[7] == 1) ? '公開' : '非公開'; ?></td>
							<td nowrap="nowrap"><?php echo date2FormatDate($dateType, $linesArray[1]); ?><?php echo ($weekDsp == 1) ? '（' . $weekArray[date('w', strtotime($linesArray[1]))] . '）' : ''; ?></td>
